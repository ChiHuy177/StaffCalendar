...
import { Card, Typography, Chip, Paper, Box } from '@mui/material';
import { motion, AnimatePresence } from 'framer-motion';
import CalendarTodayIcon from '@mui/icons-material/CalendarToday';
import { useThemeContext } from '../../../contexts/ThemeContext';
import { EventInput, EventClickArg } from '@fullcalendar/core/index.js';
import { getAllMeetingEvents } from '../../../apis/EventApi';
                        ...
                        >
                            <Paper sx={{ p: 2.5, maxWidth: 320, width: 'auto' }}>
                                ...
                                <Typography variant="body2" sx={{ color: 'text.secondary', mb: 0.5 }}>
                                    <span style={{ fontWeight: '500' }}>{t('organizer')}:</span> {selectedEvent.extendedProps?.organizer}
                                </Typography>
            ...
            <Box sx={{ maxWidth: 1200, margin: 'auto' }}>
                ...
                <Card sx={{
                    ...
                    <Box sx={{
                        ...
                        <Chip label="0" sx={{ backgroundColor: '#b39ddb', color: 'black', fontWeight: 'bold' }} />
                    </Box>
                    ...
                    <div className={isDarkMode ? 'dark-calendar' : 'light-calendar'}>
                        <FullCalendar
                            ...
                            eventContent={(arg) => {
                                ...
                                return (
                                    <div className="flex flex-col p-2 box-border items-start whitespace-normal break-words text-xs sm:text-sm md:text-base" style={{ backgroundColor: arg.event.backgroundColor, borderLeft: '4px solid #083B75' }}>
